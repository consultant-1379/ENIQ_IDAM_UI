...
export default () => {
  router.get(apiConfig.meta.routes.apps, (_req, res) => res.json(configQueryService.getApps()));
  router.get(apiConfig.meta.routes.groups, (_req, res) => res.json(configQueryService.getGroups()));
  router.get(apiConfig.meta.routes.components, (_req, res) =>
    res.json(configQueryService.getComponents()),
  );
  router.put(
    `${apiConfig.meta.routes.services}/:serviceParam`,
