...
import { getProductIndex, expandProductsPage } from '../../../../frontend/test_js/utils/utils.js';
...
describe('Mock Integration Tests', () => {
  it('can open and display mock application', async () => {
    ...
    expect(await productCardContainer.groupName()).to.startsWith(dictionary.PRODUCTS);
