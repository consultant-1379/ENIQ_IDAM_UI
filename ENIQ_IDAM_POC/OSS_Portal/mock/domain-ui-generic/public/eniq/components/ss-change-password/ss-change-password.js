...
class SsChangePassword extends LitComponent {
  ...
  validate_currentPassword(currentPassword) {
    ...
    const policyItem = this.policies_list[8];
    if (newPassword !== '') {
  ...
  password_policies(password) {
    ...
    const user_name = this.username.toLowerCase();
    ...
    const currentPassword = this.current_password.value.toLowerCase();
    const currentPassword_policy = this.policies_list[8];
  ...
  save_user() {
    ...
    if (
      ...
      this.check_currentPassword(this.current_password.value)
    ) {
      console.log({
          ...
          <div class="content-block">
            ...
            <div class="fields column-1">
              ...
              <div class="form-fields">
                <label class="required" for="username">Current password</label>
                <eui-password-field
