---
title: User Interface Serve API Documentation v1.0.0-alpha
language_tabs:
...
# User Interface Serve API Documentation v1.0.0-alpha {#user-interface-serve-api-documentation}
...
```
## Introduction
This document describes the User Interface Serve REST API identified in the ADP GUI FA.
### Terms
...
# IF.GUI.SERVE.STATIC {#user-interface-serve-api-documentation-if-gui-serve-static}
...
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|The requested static asset|None|
|404|[Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)|The requested static asset is not found|None|
...
# IF.GUI.SERVE.PACKAGE.META {#user-interface-serve-api-documentation-if-gui-serve-package-meta}
...
### Response Schema {#get-import-map-responseschema}
...
## config.package.json {#schemaconfig.package.json}
