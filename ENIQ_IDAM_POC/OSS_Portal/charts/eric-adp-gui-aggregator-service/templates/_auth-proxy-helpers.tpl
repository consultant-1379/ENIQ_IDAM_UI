{{/*
    ...
    Version: eric-sec-authorization-proxy-oauth2-1.28.0-26
*/}}
...
{{ "authpxy.version: " -}}{{- "eric-sec-authorization-proxy-oauth2-1.28.0-26" | trunc 63 | trimSuffix "-" }}
...
- name: authz-proxy-iam-client-certificates
  secret:
    secretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-iam-client-cert
    optional: true
- name: authz-proxy-sip-tls-root-ca
  secret:
...
- name: authz-proxy-iam-sap-client-certificates
  secret:
    secretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-sap-client-cert
    optional: true
  {{- else }}
- name: authz-proxy-admin-creds
  secret:
...
- name: authz-proxy-lt-client-certificates
  secret:
    secretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-lt-client-cert
    optional: true
  {{- end }}
- name: authz-proxy-pm-server-ca
  secret:
...
- name: authz-proxy-sap-client-secret
  secret:
    secretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-sap-client-secret
  {{- else }}
- name: authz-proxy-admin-creds
  secret:
    secretName: {{ $authorizationProxy.adpIamAdminSecret }}
...
- name: authz-proxy-server-certificates
  secret:
    secretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-server-cert
    optional: true
- name: authz-proxy-iccr-client-ca-certificate
  secret:
...
certificate:
  subject:
    cn: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-auth-proxy-lt-client-cert
  issuer:
...
{{- if $authorizationProxy.enabled }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-iam-client-cert
  certificateName: clicert.pem
  privateKeyName: cliprivkey.pem
certificate:
  subject:
...
{{- if $authorizationProxy.enabled }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-server-cert
...
{{- $authorizationProxy := fromJson (include "eric-adp-gui-aggregator-service.authz-proxy-values" .) -}}
kubernetes:
  generatedSecretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-sap-client-cert
  certificateName: clicert.pem
  privateKeyName: cliprivkey.pem
certificate:
  subject:
...
{{- else }}
kubernetes:
  generatedSecretName: {{ template "eric-adp-gui-aggregator-service.authz-proxy-service-name" . }}-sap-client-secret
{{- end }}
clientRoles:
