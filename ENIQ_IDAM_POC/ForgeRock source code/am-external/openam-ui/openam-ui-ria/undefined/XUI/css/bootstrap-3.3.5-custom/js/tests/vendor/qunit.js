...
(function (window) {
  ...
  */
	errorString = function errorString(error) {
		var name,
		    message,
		...
		parents = [],
			...
			return {
				...
				"object": function object(b, a) {
					...
					return eq && _innerEquiv(aProperties.sort(), bProperties.sort());
				}
			};
		}();

		_innerEquiv = function innerEquiv() {
			...
			}(args[0], args[1]) && _innerEquiv.apply(this, args.splice(1, args.length - 1));
		};
