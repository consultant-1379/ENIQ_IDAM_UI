define(["exports", "lodash"], function (exports, _lodash) {
   ...
   */
  var dataFieldObjectPath = function dataFieldObjectPath(wrappedFunction, path) {
    return function (cell, row, formatExtraData, rowIdx) {
      return wrappedFunction((0, _lodash.get)(cell, path), row, formatExtraData, rowIdx);
    };
  }; /*
      ...
      */
  exports.default = dataFieldObjectPath;
});
//# sourceMappingURL=dataFieldObjectPath.js.map
