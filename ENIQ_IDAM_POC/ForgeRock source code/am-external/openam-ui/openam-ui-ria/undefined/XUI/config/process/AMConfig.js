...
define(["jquery", "lodash", "org/forgerock/openam/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router"], function ($, _, Constants, EventManager, Router) {
    return [{
        startEvent: Constants.EVENT_LOGOUT,
        description: "used to override common logout event",
        override: true,
        dependencies: ["org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openam/ui/common/sessions/SessionValidator", "store/modules/local/session", "store/index", "org/forgerock/openam/ui/user/login/gotoUrl", "org/forgerock/openam/ui/user/login/logout", "org/forgerock/openam/ui/common/util/uri/query", "org/forgerock/commons/ui/common/util/URIUtils"],
        processDescription: function processDescription(event, Router, Configuration, SessionValidator, session, store, gotoUrl, logout, query, URIUtils) {
            ...
            var logoutFail = function logoutFail() {
                EventManager.sendEvent(Constants.EVENT_AUTHENTICATION_DATA_CHANGED, { anonymousMode: true });
            ...
            var unvalidatedGotoParam = query.parseParameters(URIUtils.getCurrentFragment()).goto || query.parseParameters(URIUtils.getCurrentQueryString()).goto;
            if (unvalidatedGotoParam) {
                gotoUrl.validateParam(unvalidatedGotoParam).then(function (validatedUrl) {
        ...
        override: true,
        dependencies: ["org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/main/Configuration"],
        processDescription: function processDescription(event, router, conf) {
        ...
        description: "",
        dependencies: ["org/forgerock/commons/ui/common/main/Configuration"],
        processDescription: function processDescription(event, conf) {
        ...
        description: "",
        dependencies: ["org/forgerock/openam/ui/admin/utils/RedirectToLegacyConsole"],
        processDescription: function processDescription(event, RedirectToLegacyConsole) {
        ...
        processDescription: function processDescription(event, Configuration, Router) {
            ...
            if (!Configuration.loggedUser) {
                ...
                Router.routeTo(Router.configuration.routes.realms, _extends({
                    args: []
                }, routerParams));
            } else {
        ...
        description: "",
        dependencies: ["Footer", "org/forgerock/commons/ui/common/components/LoginHeader"],
        processDescription: function processDescription(event, Footer, LoginHeader) {
            Footer.render();
            LoginHeader.render();
        }
    }, {
        ...
        description: "",
        dependencies: ["org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openam/ui/admin/services/global/RealmsService", "org/forgerock/openam/ui/admin/services/global/ServicesService", "org/forgerock/openam/ui/common/sessions/SessionValidator", "org/forgerock/openam/ui/common/sessions/strategies/MaxIdleTimeLeftStrategy", "org/forgerock/openam/ui/common/util/NavigationHelper"],
        processDescription: function processDescription(event, Configuration, RealmsService, ServicesService, SessionValidator, MaxIdleTimeLeftStrategy, NavigationHelper) {
            var queueName = "loginDialogAuthCallbacks";
            var authenticatedCallback = void 0;
            ...
            if (Configuration.loggedUser && Configuration.loggedUser.hasRole("ui-realm-admin")) {
                ...
                var suppressError = { errorsHandlers: { "Forbidden": { status: 403 } } };
                ServicesService.instance.get("rest", suppressError).then(NavigationHelper.hideAPILinksOnAPIDescriptionsDisabled);
            }

            if (Configuration.loggedUser && Configuration.globalData.xuiUserSessionValidationEnabled && !Configuration.loggedUser.hasRole(["ui-realm-admin", "ui-global-admin"])) {
        ...
        description: "",
        override: true,
        dependencies: ["org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openam/ui/common/RouteTo"],
        processDescription: function processDescription(event, Configuration, RouteTo) {
            if (!Configuration.loggedUser) {
                // 401 no session
        ...
        description: "",
        override: true,
        dependencies: ["LoginDialog", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Queue", "org/forgerock/openam/ui/user/login/logout"],
        processDescription: function processDescription(event, LoginDialog, Configuration, Queue, logout) {
            var queueName = "loginDialogAuthCallbacks";
            ...
            if (Configuration.loggedUser) {
                if (Configuration.loggedUser.hasRole("ui-self-service-user")) {
                    ...
                    return logout.default().then(function () {
...
//# sourceMappingURL=AMConfig.js.map
