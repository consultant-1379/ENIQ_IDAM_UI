...
define(function () {
    var scopedByRealm = function scopedByRealm(fragment) {
        return new RegExp("^realms/((?:%2F)[^/]*)/" + fragment + "$");
    };
    var defaultScopedByRealm = function defaultScopedByRealm(fragment) {
        return scopedByRealm("?(?:" + fragment + ")?");
    };
    var viewPrefix = "org/forgerock/openam/ui/admin/views/realms/";
    var routes = {
        "realms": {
...
//# sourceMappingURL=RealmsRoutes.js.map
