...
/**
  ...
  */
define(["jquery", "lodash", "backbone", "org/forgerock/openam/ui/common/models/JSONSchema", "org/forgerock/openam/ui/common/models/JSONValues", "org/forgerock/openam/ui/common/views/jsonSchema/editors/JSONEditorView"], function ($, _, Backbone, JSONSchema, JSONValues, JSONEditorView) {
    /**
    ...
    var FlatJSONSchemaView = Backbone.View.extend({
        ...
        render: function render() {
            ...
            if (this.options.showOnlyRequiredAndEmpty) {
                var requiredSchemaKeys = this.options.schema.getRequiredPropertyKeys();
                var emptyValueKeys = this.options.values.getEmptyValueKeys();
        ...
        getData: function getData() {
            if (this.subview) {
                ...
                return (_subview = this.subview).getData.apply(_subview, arguments);
            }
        },
...
//# sourceMappingURL=FlatJSONSchemaView.js.map
