...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/openam/ui/admin/services/global/RealmsService", "org/forgerock/openam/ui/common/components/TreeNavigation", "org/forgerock/openam/ui/admin/views/realms/humanizeRealmPath", "org/forgerock/openam/ui/admin/views/common/navigation/createBreadcrumbs", "org/forgerock/openam/ui/admin/views/common/navigation/createTreeNavigation"], function ($, _, Constants, EventManager, Router, RealmsService, TreeNavigation, humanizeRealmPath, createBreadcrumbs, createTreeNavigation) {
    ...
    var RealmTreeNavigationView = TreeNavigation.extend({
        ...
        realmExists: function realmExists(path) {
        ...
        render: function render(args, callback) {
            ...
            this.data.home = "#" + Router.getLink(Router.configuration.routes.realmDefault, [encodeURIComponent(this.data.realmPath)]);
...
//# sourceMappingURL=RealmTreeNavigationView.js.map
