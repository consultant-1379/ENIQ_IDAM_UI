...
define(["jquery", "lodash", "backbone", "backbone.paginator", "backgrid-filter", "org/forgerock/commons/ui/common/backgrid/Backgrid", "org/forgerock/commons/ui/common/backgrid/extension/ThemeablePaginator", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/BackgridUtils"], function ($, _, Backbone, BackbonePaginator, BackgridFilter, Backgrid, ThemeablePaginator, AbstractView, Configuration, Constants, fetchUrl, BackgridUtils) {
    var HistoryView = AbstractView.extend({
        ...
        render: function render() {
            ...
            collection = new (Backbone.PageableCollection.extend({
                url: Constants.context + "/json" + fetchUrl.default("/users/" + Configuration.loggedUser.get("username") + "/uma/auditHistory"),
                state: {
                    pageSize: 10,
                    sortKey: "eventTime",
                    order: 1
...
//# sourceMappingURL=ListHistory.js.map
