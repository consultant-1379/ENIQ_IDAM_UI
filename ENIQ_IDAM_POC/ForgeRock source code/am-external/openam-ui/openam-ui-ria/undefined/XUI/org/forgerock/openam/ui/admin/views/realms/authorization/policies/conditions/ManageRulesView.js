...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/EditEnvironmentView", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/EditSubjectView", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/OperatorRulesView", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/LegacyListItemView",

// jquery dependencies
"sortable"], function ($, _, AbstractView, EventManager, Constants, UIUtils, EditEnvironmentView, EditSubjectView, OperatorRulesView, LegacyListItemView) {
    ...
    return AbstractView.extend({
        ...
        initialize: function initialize() {
            ...
            UIUtils.preloadTemplates(_.map(["ConditionAttrEnum", "ConditionAttrString", "ConditionAttrBoolean", "ConditionAttrArray", "ConditionAttrObject", "ConditionAttrTime", "ConditionAttrDay", "ConditionAttrDate", "OperatorRulesTemplate", "EditSubjectTemplate", "EditEnvironmentTemplate"], function (filename) {
                return "templates/admin/views/realms/authorization/policies/conditions/" + filename + ".html";
            }));
        },
        init: function init(args, events) {
        ...
        initSorting: function initSorting() {
            ...
            this.$el.find("ol#dropbox").nestingSortable({
                ...
                isValidTarget: function isValidTarget(item, container) {
                    var notValid = container.items.length > 0 && container.target.parent().data().itemData && container.target.parent().data().itemData[self.property] || item.hasClass("editing-disabled");
        ...
        editStart: function editStart(item) {
        ...
        editStop: function editStop(item) {
        ...
        setInactive: function setInactive(button, state) {
        ...
        addCondition: function addCondition(e) {
            e.preventDefault();
         ...
         */
        identifyDroppableLogical: function identifyDroppableLogical() {
            ...
            if (rootLogical.hasClass("not")) {
                ...
                if (nestedLogicalsLength) {
                    ...
                    for (; i < nestedLogicalsLength; i++) {
                        ...
                        notIsEmpty = logical.hasClass("not") && logical.children(".dropbox").children("li").length === 0;
...
//# sourceMappingURL=ManageRulesView.js.map
