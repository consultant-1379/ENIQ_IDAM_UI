...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractConfigurationAware", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/ServiceInvoker", "org/forgerock/commons/ui/common/main/ViewManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/URIUtils", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/user/services/AuthNService", "org/forgerock/openam/ui/user/services/SessionService", "org/forgerock/openam/ui/user/UserModel", "org/forgerock/openam/ui/user/login/logout", "org/forgerock/openam/ui/common/util/uri/query", "org/forgerock/openam/ui/user/login/gotoUrl"], function ($, _, AbstractConfigurationAware, Configuration, ServiceInvoker, ViewManager, Constants, URIUtils, fetchUrl, AuthNService, SessionService, UserModel, logout, query, gotoUrl) {
    ...
    obj.getLoggedUser = function (successCallback, errorCallback) {
        var noSessionHandler = function noSessionHandler(xhr) {
        ...
        ServiceInvoker.restCall({
            url: "" + Constants.host + Constants.context + "/json" + fetchUrl.default("/users?_action=idFromSession"),
        ...
        return SessionService.updateSessionInfo().then(function (data) {
    ...
    obj.getSuccessfulLoginUrlParams = function () {
        ...
        var fullLoginURL = Configuration.globalData.auth.fullLoginURL;
        var paramString = fullLoginURL ? fullLoginURL.substring(fullLoginURL.indexOf("?") + 1) : "";
    ...
    obj.filterUrlParams = function (params) {
        var filtered = ["arg", "authIndexType", "authIndexValue", "goto", "gotoOnFail", "ForceAuth", "locale"];
        return _.reduce(_.pick(params, filtered), function (result, value, key) {
...
//# sourceMappingURL=RESTLoginHelper.js.map
