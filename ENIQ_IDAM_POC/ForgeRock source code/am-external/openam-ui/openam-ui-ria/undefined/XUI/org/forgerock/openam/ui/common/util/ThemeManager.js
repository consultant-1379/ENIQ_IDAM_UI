...
define(["jquery", "lodash", "config/ThemeConfiguration", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/URIUtils", "org/forgerock/openam/ui/common/util/Constants", "Router", "store/index"], function ($, _, ThemeConfiguration, Configuration, EventManager, URIUtils, Constants, Router, store) {
    /**
     * @exports org/forgerock/openam/ui/common/util/ThemeManager
     */

    var defaultThemeName = "default",
        applyThemeToPage = function applyThemeToPage(path, icon, stylesheets) {
     ...
     */
    isMatchingThemeMapping = function isMatchingThemeMapping(realm, authenticationChain, mapping) {
        var matchers = {
            realms: realm,
     ...
     */
    findMatchingTheme = function findMatchingTheme(realm, authenticationChain) {
        if (!_.isArray(ThemeConfiguration.mappings)) {
            return defaultThemeName;
        }
        var matchedThemeMapping = _.find(ThemeConfiguration.mappings, _.partial(isMatchingThemeMapping, realm, authenticationChain));
        if (matchedThemeMapping) {
            return matchedThemeMapping.theme;
        }
        return defaultThemeName;
    },
        makeUrlsRelativeToEntryPoint = function makeUrlsRelativeToEntryPoint(theme) {
        ...
        extendTheme = function extendTheme(theme, parentTheme) {
    ...
    getAuthenticationChainName = function getAuthenticationChainName() {
    ...
    return {
        ...
        getTheme: function getTheme() {
            ...
            var realm = store.default.getState().remote.info.realm || Configuration.globalData.realm;
