...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "autosizeInput", "doTimeout"], function ($, _, AbstractView, EventManager, Constants, UIUtils) {
    var CreatedResourcesView = AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            this.parentRender(function () {
                _this.$el.find(".selectize").selectize({
                    sortField: {
                        field: "text",
                        direction: "asc"
                    },
                    onChange: function onChange(value) {
                        ...
                        UIUtils.fillTemplateWithData("templates/admin/views/realms/authorization/policies/PopulateResourceTemplate.html", self.data, function (content) {
        ...
        removePendingResource: function removePendingResource(e) {
            if (e.type === "keyup" && e.keyCode !== 13) {
                return;
            }
        ...
        deleteResource: function deleteResource(e) {
            if (e.type === "keyup" && e.keyCode !== 13) {
                return;
            }
        ...
        showEditingResources: function showEditingResources() {
...
//# sourceMappingURL=CreatedResourcesView.js.map
