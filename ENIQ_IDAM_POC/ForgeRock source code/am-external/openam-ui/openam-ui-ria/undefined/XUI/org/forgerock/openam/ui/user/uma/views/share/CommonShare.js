...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/backgrid/Backgrid", "org/forgerock/openam/ui/common/util/BackgridUtils", "org/forgerock/commons/ui/common/components/BootstrapDialog", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openam/ui/user/uma/views/share/ShareCounter", "org/forgerock/openam/ui/user/uma/models/UMAPolicy", "org/forgerock/openam/ui/user/uma/models/UMAPolicyPermission", "org/forgerock/openam/ui/user/uma/models/UMAPolicyPermissionScope", "org/forgerock/openam/ui/user/uma/models/UMAResourceSetWithPolicy", "org/forgerock/openam/ui/common/util/RealmHelper",

// jquery dependencies
"selectize"], function ($, _, AbstractView, Backgrid, BackgridUtils, BootstrapDialog, Constants, EventManager, ShareCounter, UMAPolicy, UMAPolicyPermission, UMAPolicyPermissionScope, UMAResourceSetWithPolicy, RealmHelper) {
    var CommonShare,
        realmRegex = /[?&]realm=/,
    ...
    $.ajaxPrefilter(function (options) {
        if ((resourcesetsRegex.test(options.url) || policyRegex.test(options.url)) && !realmRegex.test(options.url) && RealmHelper.getOverrideRealm()) {
    ...
    CommonShare = AbstractView.extend({
        ...
        enableOrDisableShareButton: function enableOrDisableShareButton() {
        ...
        onParentModelError: function onParentModelError(model, response) {
        ...
        onParentModelSync: function onParentModelSync(model) {
         ...
         */
        syncParentModel: function syncParentModel(id) {
        ...
        renderDialog: function renderDialog(args, callback) {
            var self = this,
                $div = $("<div></div>"),
        ...
        renderPermissionOptions: function renderPermissionOptions() {
            var self = this;
        ...
        renderUserOptions: function renderUserOptions() {
            var self = this;
        ...
        save: function save() {
            ...
            policy.save().then(function () {
                ...
                _this.toBeCreated = false;
                if (_this.afterShare) {
                    _this.afterShare();
                }
            });
        },
        renderShareCounter: function renderShareCounter(callback) {
...
//# sourceMappingURL=CommonShare.js.map
