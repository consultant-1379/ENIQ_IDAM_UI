...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/components/BootstrapDialog", "handlebars"], function ($, _, AbstractView, BootstrapDialog, Handlebars) {
    var PostProcessView = AbstractView.extend({
        ...
        add: function add() {
            ...
            if (invalidName) {
                this.$el.find("#alertContainer").html(Handlebars.compile("{{> alerts/_Alert type='warning' " + "text='console.authentication.editChains.processingClass.duplicateClass'}}"));
            } else {
        ...
        addClassNameDialog: function addClassNameDialog() {
            var self = this,
                promise = $.Deferred(),
        ...
        render: function render(chainData) {
...
//# sourceMappingURL=PostProcessView.js.map
