...
*/
define(["lodash", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/admin/utils/AdministeredRealmsHelper", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/RealmHelper"], function (_, AbstractDelegate, Constants, AdministeredRealmsHelper, fetchUrl, RealmHelper) {
    var obj = new AbstractDelegate("" + Constants.host + Constants.context + "/json"),
        getCurrentAdministeredRealm = function getCurrentAdministeredRealm() {
    ...
    obj.listResourceTypes = function () {
        return obj.serviceCall({
            url: fetchUrl.default("/resourcetypes?_queryFilter=name+eq+" + encodeURIComponent('"^(?!Delegation Service$).*"'), { realm: getCurrentAdministeredRealm() }),
            headers: { "Accept-API-Version": "protocol=1.0,resource=1.0" }
        });
    };
