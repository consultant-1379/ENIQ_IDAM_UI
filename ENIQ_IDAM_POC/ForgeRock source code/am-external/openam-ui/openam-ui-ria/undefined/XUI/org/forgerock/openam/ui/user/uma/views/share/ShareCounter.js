...
define(["jquery", "org/forgerock/commons/ui/common/main/AbstractView"], function ($, AbstractView) {
    var ShareCounter = AbstractView.extend({
        ...
        render: function render(count, callback) {
        ...
        getShareInfo: function getShareInfo(count) {
            var options = count ? { count: count } : { context: "none" };
            return $.t("uma.share.info", options);
        },
        getShareIcon: function getShareIcon(count) {
...
//# sourceMappingURL=ShareCounter.js.map
