 ...
 */
define(["lodash", "org/forgerock/openam/ui/common/util/Promise"], function (_, Promise) {
    var obj = {};
    ...
    */
    ...
    obj.sanitizeSchema = function (schema) {
         ...
         */
        eachProperty(transformedSchema, [transformBooleanTypeToCheckboxFormat, transformEnumTypeToString, warnOnInferredPasswordWithoutFormat]);
    ...
    obj.schemaWithDefaults = function (delegate, url) {
        return Promise.all([delegate.serviceCall({
...
//# sourceMappingURL=SMSServiceUtils.js.map
