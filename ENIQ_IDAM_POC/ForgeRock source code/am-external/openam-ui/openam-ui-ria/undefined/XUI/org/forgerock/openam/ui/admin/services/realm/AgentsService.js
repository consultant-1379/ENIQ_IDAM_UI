define(["exports", "lodash", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/Promise"], function (exports, _lodash, _AbstractDelegate, _Constants, _fetchUrl, _Promise) {
    ...
    exports.getCreatableTypes = getCreatableTypes;
     ...
     */
    function getCreatableTypes(realm) {
        return obj.serviceCall({
            url: (0, _fetchUrl2.default)("/realm-config/agents?_action=getCreatableTypes", { realm: realm }),
            type: "POST",
    ...
    function create(realm, type, data, id) {
        return obj.serviceCall({
            url: (0, _fetchUrl2.default)("/realm-config/agents/" + type + "/" + encodeURIComponent(id), { realm: realm }),
            type: "PUT",
            headers: {
    ...
    function getSchema(realm, type) {
        return obj.serviceCall({
            url: (0, _fetchUrl2.default)("/realm-config/agents/" + type + "?_action=schema", { realm: realm }),
            headers: { "Accept-API-Version": "protocol=2.0,resource=1.0" },
            type: "POST"
        });
    }
    ...
    function getAll(realm, type) {
        return obj.serviceCall({
            url: (0, _fetchUrl2.default)("/realm-config/agents/" + type + "?_queryFilter=true", { realm: realm }),
            headers: { "Accept-API-Version": "protocol=2.0,resource=1.0" },
            suppressSpinner: true
        });
    }
    ...
    function getInitialState(realm, type) {
        function getTemplate() {
            return obj.serviceCall({
                url: (0, _fetchUrl2.default)("/realm-config/agents/" + type + "?_action=template", { realm: realm }),
                headers: { "Accept-API-Version": "protocol=1.0,resource=1.0" },
                type: "POST"
            });
        }
