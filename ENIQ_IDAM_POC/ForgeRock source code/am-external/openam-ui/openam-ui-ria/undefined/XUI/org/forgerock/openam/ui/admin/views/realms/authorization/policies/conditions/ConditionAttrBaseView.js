...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView"], function ($, _, AbstractView) {
    return AbstractView.extend({
        ...
        initBasic: function initBasic(data, el, cssClasses) {
        ...
        populateInputGroup: function populateInputGroup(target) {
        ...
        populateAutoFillGroup: function populateAutoFillGroup(target) {
...
//# sourceMappingURL=ConditionAttrBaseView.js.map
