...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/openam/ui/admin/utils/RedirectToLegacyConsole"], function ($, _, AbstractView, RedirectToLegacyConsole) {
    var DashboardTasksView = AbstractView.extend({
        ...
        commonTasksBtnClick: function commonTasksBtnClick(e) {
            e.preventDefault();
            this.data.taskGroup = {};
...
//# sourceMappingURL=DashboardTasksView.js.map
