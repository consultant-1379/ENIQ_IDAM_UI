...
define([], function () {
    ...
    return function warnOnInferredPasswordWithoutFormat(property, name) {
        ...
        var hasFormat = property.format === "password";
        if (property.type === "string" && possiblePassword && !hasFormat) {
            console.error("[cleanJSONSchema] Detected (inferred) a password property \"" + name + "\" " + "without format attribute of \"password\"");
        }
    };
});
//# sourceMappingURL=warnOnInferredPasswordWithoutFormat.js.map
