define(["exports", "handlebars", "backbone"], function (exports, _handlebars, _backbone) {
    "use strict";
    ...
    var TemplateComponent = function (_View) {
        _inherits(TemplateComponent, _View);
        ...
        _createClass(TemplateComponent, [{
            ...
            value: function render() {
                var html = _handlebars2.default.compile(this.template)(this.data);
                this.$el.html(html);
                return this;
            }
        }, {
