...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/ConditionAttrArrayView", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/ConditionAttrStringView"], function ($, _, AbstractView, UIUtils, ArrayAttr, StringAttr) {
    return AbstractView.extend({
        ...
        createListItem: function createListItem(allSubjects, item) {
            var self = this,
                itemToDisplay = null,
        ...
        animateOut: function animateOut() {
            ...
            this.$el.find(".field-float-pattern, .field-float-selectize").find("label").removeClass("showLabel").next("input, div input").addClass("placeholderText").prop("readonly", true);
        ...
        animateIn: function animateIn() {
            var self = this;
            setTimeout(function () {
                self.$el.find(".field-float-pattern, .field-float-selectize").find("label").addClass("showLabel").next("input, div input").removeClass("placeholderText").prop("readonly", false);
            }, 10);
        },
        getUIDsFromUniversalValues: function getUIDsFromUniversalValues(values) {
...
//# sourceMappingURL=EditSubjectView.js.map
