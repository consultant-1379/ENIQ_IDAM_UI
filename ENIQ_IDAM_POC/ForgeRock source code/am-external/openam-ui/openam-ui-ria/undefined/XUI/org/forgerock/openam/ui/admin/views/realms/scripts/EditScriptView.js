...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/components/BootstrapDialog", "libs/codemirror/lib/codemirror", "org/forgerock/commons/ui/common/components/ChangesPending", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/Base64", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openam/ui/admin/models/scripts/ScriptModel", "org/forgerock/openam/ui/admin/services/realm/ScriptsService", "org/forgerock/openam/ui/admin/services/global/ScriptsService", "org/forgerock/openam/ui/admin/utils/FormHelper", "org/forgerock/openam/ui/common/util/Promise", "libs/codemirror/mode/groovy/groovy", "libs/codemirror/mode/javascript/javascript", "libs/codemirror/addon/display/fullscreen",
// jquery dependencies
"selectize"], function ($, _, BootstrapDialog, CodeMirror, ChangesPending, Messages, AbstractView, EventManager, Router, Base64, Constants, UIUtils, Script, RealmScriptsService, GlobalScriptsService, FormHelper, Promise) {
    return AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            if (uuid) {
                this.data.headerActions = [{ actionPartial: "form/_Button", data: "delete", title: "common.form.delete", icon: "fa-times" }];
         ...
         */
        renderAfterSyncModel: function renderAfterSyncModel() {
            var self = this;
            ...
            if (this.data.contexts) {
                ...
                Promise.all([self.contextsPromise, self.defaultContextPromise, self.contextSchemaPromise, self.languageSchemaPromise]).done(function (results) {
        ...
        cleanupAfterCodemirror: function cleanupAfterCodemirror() {
        ...
        renderScript: function renderScript() {
            var self = this,
                context;
            ...
            this.parentRender(function () {
                if (this.newEntity) {
                    ...
                    this.changesPendingWidget = ChangesPending.watchChanges({
                        ...
                        undo: !this.newEntity,
                        undoCallback: function undoCallback(changes) {
        ...
        reRenderView: function reRenderView() {
            this.parentRender(function () {
                this.showUploadButton();
                this.initScriptEditor();
        ...
        validateScript: function validateScript() {
            ...
            RealmScriptsService.validateScript(script).done(function (result) {
                UIUtils.fillTemplateWithData("templates/admin/views/realms/scripts/ScriptValidationTemplate.html", result, function (tpl) {
        ...
        uploadScript: function uploadScript() {
            this.$el.find("[name=upload]").trigger("click");
        },
        readUploadedFile: function readUploadedFile(e) {
            var self = this,
        ...
        constructDialogOptions: function constructDialogOptions() {
            var self = this,
                footerButtons = [],
                options = {
                ...
                onshow: function onshow() {
                    var dialog = this;
                    UIUtils.fillTemplateWithData("templates/admin/views/realms/scripts/ChangeContextTemplate.html", self.data, function (tpl) {
        ...
        onChangeLanguage: function onChangeLanguage(e) {
         ...
         */
        addContextNames: function addContextNames(contexts, schema) {
            var i,
                index,
         ...
         */
        addLanguageNames: function addLanguageNames(languages) {
            var result,
                i,
                length = languages.length,
                index;
            if (this.langSchema && this.langSchema.properties && this.langSchema.properties.languages && this.langSchema.properties.languages.items) {
                result = [];
                for (i = 0; i < length; i++) {
        ...
        onDeleteClick: function onDeleteClick(e) {
            ...
            FormHelper.showConfirmationBeforeDeleting({ type: $.t("console.scripts.edit.script") }, _.bind(this.deleteScript, this));
        },
        ...
        editFullScreen: function editFullScreen() {
        ...
        toggleSaveButton: function toggleSaveButton(flag) {
            this.$el.find("[data-save]").prop("disabled", !flag);
        }
    });
});
//# sourceMappingURL=EditScriptView.js.map
