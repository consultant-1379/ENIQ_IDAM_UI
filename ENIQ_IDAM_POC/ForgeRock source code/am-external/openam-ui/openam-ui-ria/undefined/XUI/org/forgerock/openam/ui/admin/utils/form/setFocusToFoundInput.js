define(["exports"], function (exports) {
   ...
   */
  var setFocusToFoundInput = function setFocusToFoundInput(element) {
    var input = element.find("input");
    var inheritedInput = input.prop("disabled") === true;
    if (inheritedInput) {
  ...
  exports.default = setFocusToFoundInput;
});
//# sourceMappingURL=setFocusToFoundInput.js.map
