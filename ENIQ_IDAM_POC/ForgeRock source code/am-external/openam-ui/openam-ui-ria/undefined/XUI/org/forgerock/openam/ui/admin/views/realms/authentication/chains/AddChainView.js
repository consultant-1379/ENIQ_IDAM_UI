 ...
 */
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/openam/ui/admin/services/realm/AuthenticationService"], function ($, _, AbstractView, Router, Messages, AuthenticationService) {
    ...
    return AbstractView.extend({
        ...
        save: function save() {
            ...
            AuthenticationService.authentication.chains.create(self.data.realmPath, { _id: name }).then(function () {
        ...
        onValidateChainProps: function onValidateChainProps() {
            validateChainProps.call(this);
        }
    });
});
//# sourceMappingURL=AddChainView.js.map
