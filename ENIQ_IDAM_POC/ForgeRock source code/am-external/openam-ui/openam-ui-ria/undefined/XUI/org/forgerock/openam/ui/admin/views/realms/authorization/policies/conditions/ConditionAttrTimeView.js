...
define(["jquery", "lodash", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/ConditionAttrBaseView", "clockPicker"], function ($, _, ConditionAttrBaseView) {
    return ConditionAttrBaseView.extend({
        ...
        clickClockPicker: function clickClockPicker(e) {
            e.stopPropagation();
        ...
        initClockPickers: function initClockPickers() {
...
//# sourceMappingURL=ConditionAttrTimeView.js.map
