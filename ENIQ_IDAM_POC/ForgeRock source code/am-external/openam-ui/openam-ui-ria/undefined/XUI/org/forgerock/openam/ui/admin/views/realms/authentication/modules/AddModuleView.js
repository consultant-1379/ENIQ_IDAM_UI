 ...
 */
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/openam/ui/admin/services/realm/AuthenticationService", "org/forgerock/openam/ui/common/components/SelectComponent"], function ($, _, AbstractView, Router, Messages, AuthenticationService, SelectComponent) {
    ...
    return AbstractView.extend({
        ...
        save: function save() {
            ...
            modulesService.exists(self.data.realmPath, moduleName).then(function (result) {
                ...
                if (result) {
                    ...
                    authenticationModules.create(self.data.realmPath, { _id: moduleName }, moduleType).then(function () {
        ...
        onValidateModuleProps: function onValidateModuleProps() {
            validateModuleProps.call(this);
        }
    });
});
//# sourceMappingURL=AddModuleView.js.map
