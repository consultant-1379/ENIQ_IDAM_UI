 ...
 * @deprecated
 */
define(["jquery", "lodash", "jsonEditor", "org/forgerock/openam/ui/admin/utils/JSONEditorTheme", "popoverclickaway", // depends on jquery and bootstrap
"selectize" // jquery dependencies
    ...
    var obj = function Form(element, schema, values) {
        ...
        var passwordProperties = _.where(schema.properties, { format: "password" });
        this.passwordAttributes = _.map(passwordProperties, function (property) {
            return _.findKey(schema.properties, property);
        });
        ...
        $(element).find(".help-block").addClass("hidden-lg hidden-md hidden-sm").each(function () {
            var group = $(this).parent(),
                element = $('<a class="btn info-button visible-lg-inline-block' + ' visible-md-inline-block visible-sm-inline-block" ' + 'tabindex="0" data-toggle="popoverclickaway" ><i class="fa fa-info-circle"></i></a>');
