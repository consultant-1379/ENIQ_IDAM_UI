...
define(["lodash", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/URIUtils", "org/forgerock/commons/ui/user/anonymousProcess/AnonymousProcessView", "org/forgerock/commons/ui/user/delegates/AnonymousProcessDelegate", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/Constants", "org/forgerock/openam/ui/common/util/uri/getCurrentFragmentParamString", "org/forgerock/openam/ui/common/util/uri/query", "store/index"], function (_, EventManager, Router, URIUtils, AnonymousProcessView, AnonymousProcessDelegate, fetchUrl, Constants, getCurrentFragmentParamString, query, store) {
    ...
    return AnonymousProcessView.extend({
        render: function render() {
            var fragmentParams = query.parseParameters(URIUtils.getCurrentFragmentQueryString());
            var nextRoute = getNextRoute(this.endpoint);
            var endpoint = fetchUrl.default("/" + this.endpoint, {
            ...
            if (isFromEmailLink(fragmentParams)) {
                this.submitDelegate(fragmentParams, function () {
...
//# sourceMappingURL=AnonymousProcessView.js.map
