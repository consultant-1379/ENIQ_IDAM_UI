...
define(["jquery", "lodash", "org/forgerock/openam/ui/admin/models/authorization/PolicySetModel", "org/forgerock/openam/ui/admin/views/realms/authorization/common/StripedListView", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/PoliciesView", "org/forgerock/openam/ui/admin/services/realm/PoliciesService", "org/forgerock/openam/ui/admin/utils/FormHelper", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "bootstrap-tabdrop", "selectize"], function ($, _, PolicySetModel, StripedListView, PoliciesView, PoliciesService, FormHelper, Messages, AbstractView, EventManager, Router, Constants, UIUtils) {
    return AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            if (policySetName) {
                ...
                this.data.headerActions = [{ actionPartial: "form/_Button", data: "delete", title: "common.form.delete", icon: "fa-times" }, { actionPartial: "util/_HelpLink", helpLink: "backstage.authz.policySets" }];
        ...
        renderApplication: function renderApplication() {
            var self = this,
                parentRenderCallback = function parentRenderCallback() {
                self.parentRender(function () {
                    PoliciesView.render({
                        ...
                        UIUtils.fillTemplateWithData("templates/admin/views/realms/authorization/policySets/PolicySetSettingsTemplate.html", self.data, function (tpl) {
                ...
                populateAvailableResourceTypes = function populateAvailableResourceTypes(resourceTypes) {
                var options = {};
                ...
                options.selectedResourceTypes = _.findByValues(options.allResourceTypes, "uuid", self.data.entity.resourceTypeUuids);
            ...
            if (this.model.id) {
                ...
                $.when(this.appTypePromise, this.envConditionsPromise, this.subjConditionsPromise, this.decisionCombinersPromise, this.resourceTypesPromise).done(function (appType, envConditions, subjConditions, decisionCombiners, resourceTypes) {
        ...
        populateResourceTypes: function populateResourceTypes() {
            var self = this;
        ...
        processConditions: function processConditions(data, envConditions, subjConditions) {
            if (!data.entityId) {
        ...
        populateConditions: function populateConditions(selected, available) {
            var result = [];
        ...
        onDeleteClick: function onDeleteClick(e) {
            ...
            FormHelper.showConfirmationBeforeDeleting({ type: $.t("console.authorization.common.policySet") }, _.bind(this.deletePolicySet, this));
        },
        deletePolicySet: function deletePolicySet() {
            var self = this,
        ...
        updateFields: function updateFields() {
            ...
            var dataFields = this.$el.find("[data-field]");
            ...
            _.each(dataFields, function (field) {
                ...
                if (field.type === "checkbox") {
                    if (field.checked) {
                        _this.data.entity[dataField].push(field.value);
                    }
                } else {
                    _this.data.entity[dataField] = _.trim(field.value);
                }
            });
        }
    });
});
//# sourceMappingURL=EditPolicySetView.js.map
