...
define(["lodash", "org/forgerock/openam/ui/common/util/Constants", "org/forgerock/openam/ui/user/anonymousProcess/AnonymousProcessView", "org/forgerock/commons/ui/user/anonymousProcess/SelfRegistrationView", "org/forgerock/commons/ui/user/anonymousProcess/KBAView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openam/ui/user/login/RESTLoginView"], function (_, Constants, AnonymousProcessView, SelfRegistrationView, KBAView, Configuration, RESTLoginView) {
    ...
    AMSelfRegistrationView.prototype.renderProcessState = function (response) {
        var destination = _.get(Configuration, "globalData.successfulUserRegistrationDestination");
        var realm = _.get(Configuration, "globalData.realm", "");
...
//# sourceMappingURL=SelfRegistrationView.js.map
