...
define(["lodash", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/URIUtils"], function (_, Configuration, URIUtils) {
    /**
    ...
    obj.decorateURIWithSubRealm = function (uri) {
        ...
        if (persisted && persisted.auth && (persisted.auth.subRealm === undefined || persisted.auth.subRealm === null)) {
    ...
    obj.getSubRealm = function () {
        var subRealmSplit = URIUtils.getCurrentFragment().split("/"),
            ...
            subRealmSpecifiablePages = ["login", "passwordReset", "continuePasswordReset", "register", "continueRegister"],
            subRealm;
...
//# sourceMappingURL=RealmHelper.js.map
