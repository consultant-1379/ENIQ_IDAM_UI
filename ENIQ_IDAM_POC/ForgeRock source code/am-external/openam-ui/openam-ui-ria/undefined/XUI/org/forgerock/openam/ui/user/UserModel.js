...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/openam/ui/common/util/array/arrayify", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/main/ServiceInvoker", "org/forgerock/openam/ui/common/util/object/flattenValues", "org/forgerock/openam/ui/common/services/fetchUrl"], function ($, _, AbstractModel, arrayify, Configuration, Constants, Messages, Router, ServiceInvoker, flattenValues, fetchUrl) {
    var baseUrl = "" + Constants.host + Constants.context + "/json",
        ...
        silentReset: function silentReset() {
            ...
            if (method === "update" || method === "patch") {
                if (_.has(this.changed, "password")) {
                    ...
                    return ServiceInvoker.restCall({
                        url: baseUrl + fetchUrl.default("/users/" + encodeURIComponent(this.id) + "?_action=changePassword"),
                    ...
                    return ServiceInvoker.restCall(_.extend({
                        type: "PUT",
                        data: JSON.stringify(_.chain(this.toJSON()).pick(["givenName", "sn", "mail", "postalAddress", "telephoneNumber"]).mapValues(function (val) {
        ...
        fetchById: function fetchById(id) {
            ...
            return this.set({ id: id }, { silent: true }).fetch().then(function () {
                return _this;
            });
        },
