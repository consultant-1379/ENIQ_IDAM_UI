...
define(["jquery", "lodash", "org/forgerock/openam/ui/admin/views/realms/authorization/policies/conditions/ConditionAttrBaseView",

// jquery dependencies
"selectize"], function ($, _, ConditionAttrBaseView) {
    return ConditionAttrBaseView.extend({
        ...
        initSelectize: function initSelectize() {
            var view = this,
                title = "",
                itemData,
                options,
            ...
            this.$el.find("select.selectize").each(function () {
                ...
                options = {
                    ...
                    createFilter: function createFilter(text) {
...
//# sourceMappingURL=ConditionAttrObjectView.js.map
