...
define(["lodash"], function (_) {
    return function (schemaValuePair) {
        var allPropertiesHidden = _.isEmpty(schemaValuePair.schema.raw.defaultProperties);

        if (allPropertiesHidden && schemaValuePair.schema.hasEnableProperty()) {
            return _.extend(schemaValuePair, {
                schema: schemaValuePair.schema.getEnableProperty().addDefaultProperties([schemaValuePair.schema.getEnableKey()])
            });
        }
...
//# sourceMappingURL=showEnablePropertyIfAllPropertiesHidden.js.map
