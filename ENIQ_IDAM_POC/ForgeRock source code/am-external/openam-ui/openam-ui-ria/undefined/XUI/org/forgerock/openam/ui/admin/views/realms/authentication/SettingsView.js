...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/openam/ui/admin/models/Form", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/openam/ui/admin/services/SMSServiceUtils", "org/forgerock/openam/ui/admin/services/realm/AuthenticationService",

// jquery dependencies
"bootstrap-tabdrop"], function ($, _, AbstractView, Constants, EventManager, Form, Messages, SMSServiceUtils, AuthenticationService) {
    var SettingsView = AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            AuthenticationService.authentication.get(this.data.realmLocation).then(function (data) {
        ...
        renderTab: function renderTab(event) {
        ...
        save: function save() {
            ...
            AuthenticationService.authentication.update(this.data.realmLocation, formData).then(function (data) {
