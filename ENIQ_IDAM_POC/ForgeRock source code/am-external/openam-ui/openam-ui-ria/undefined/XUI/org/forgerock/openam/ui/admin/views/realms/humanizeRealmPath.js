define(["exports", "lodash", "i18next"], function (exports, _lodash, _i18next) {
  "use strict";
  ...
  var humanizeRealmPath = function humanizeRealmPath(realmPath) {
    return realmPath === "/" ? (0, _i18next.t)("console.common.topLevelRealm") : (0, _lodash.last)(realmPath.split("/"));
  };

  exports.default = humanizeRealmPath;
});
//# sourceMappingURL=humanizeRealmPath.js.map
