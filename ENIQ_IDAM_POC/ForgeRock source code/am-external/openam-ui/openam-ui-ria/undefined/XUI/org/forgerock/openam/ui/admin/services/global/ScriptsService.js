...
define(["lodash", "org/forgerock/commons/ui/common/main/AbstractDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/common/services/fetchUrl"], function (_, AbstractDelegate, Constants, fetchUrl) {
    ...
    obj.scripts = {
         ...
         */
        getAllDefault: function getAllDefault(subSchemaType) {
            return obj.serviceCall({
                url: fetchUrl.default("/scripts?_pageSize=10&_sortKeys=name&_queryFilter=default eq true and context " + ("eq \"" + subSchemaType + "\"&_pagedResultsOffset=0"), { realm: false }),
         ...
         * @returns {Promise.<Object>} Service promise
         */
        getDefaultGlobalContext: function getDefaultGlobalContext() {
            return obj.serviceCall({
         ...
         * @returns {Promise.<Object>} Service promise
         */
        getContextSchema: function getContextSchema() {
            return obj.serviceCall({
...
//# sourceMappingURL=ScriptsService.js.map
