...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openam/ui/admin/models/authorization/ResourceTypeModel", "org/forgerock/openam/ui/admin/views/realms/authorization/resourceTypes/ResourceTypePatternsView", "org/forgerock/openam/ui/admin/views/realms/authorization/resourceTypes/ResourceTypeActionsView", "org/forgerock/openam/ui/admin/utils/FormHelper", "bootstrap-tabdrop"], function ($, _, Messages, AbstractView, EventManager, Router, Constants, UIUtils, ResourceTypeModel, ResourceTypePatternsView, ResourceTypeActionsView, FormHelper) {
    return AbstractView.extend({
        ...
        tabs: [{ name: "patterns", attr: ["patterns"] }, { name: "actions", attr: ["actions"] }, { name: "settings", attr: ["name", "description"] }],
        ...
        render: function render(args, callback) {
            ...
            if (uuid) {
                ...
                this.data.headerActions = [{ actionPartial: "form/_Button", data: "delete", title: "common.form.delete", icon: "fa-times" }, { actionPartial: "util/_HelpLink", helpLink: "backstage.authz.resourceTypes" }];
        ...
        renderSettings: function renderSettings() {
            var self = this;
            UIUtils.fillTemplateWithData("templates/admin/views/realms/authorization/resourceTypes/ResourceTypeSettingsTemplate.html", this.data, function (tpl) {
        ...
        onDeleteClick: function onDeleteClick(e) {
            ...
            FormHelper.showConfirmationBeforeDeleting({ type: $.t("console.authorization.common.resourceType") }, _.bind(this.deleteResourceType, this));
        },
        deleteResourceType: function deleteResourceType() {
            var self = this,
...
//# sourceMappingURL=EditResourceTypeView.js.map
