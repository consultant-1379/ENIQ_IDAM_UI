...
define(["jquery", "backbone", "backbone.paginator", "backgrid-filter", "org/forgerock/commons/ui/common/backgrid/Backgrid", "org/forgerock/commons/ui/common/backgrid/extension/ThemeablePaginator", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/BackgridUtils", "org/forgerock/openam/ui/user/uma/services/UMAService", "org/forgerock/openam/ui/user/uma/views/backgrid/cells/PermissionsCell"], function ($, Backbone, BackbonePaginator, BackgridFilter, Backgrid, ThemeablePaginator, AbstractView, Configuration, Constants, fetchUrl, BackgridUtils, UMAService, PermissionsCell) {
    var ListRequest = AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            RequestsCollection = Backbone.PageableCollection.extend({
                url: Constants.context + "/json" + fetchUrl.default("/users/" + Configuration.loggedUser.get("username") + "/uma/pendingrequests"),
                state: {
                    pageSize: 10,
                    sortKey: "user"
                },
