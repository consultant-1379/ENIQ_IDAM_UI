...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/UIUtils"], function ($, _, AbstractView, UIUtils) {
    return AbstractView.extend({
        data: {},
        mode: "append",
        render: function render(itemData, callback, element, itemID) {
            ...
            UIUtils.fillTemplateWithData("templates/admin/views/realms/authorization/policies/conditions/LegacyListItem.html", this.data, function () {
...
//# sourceMappingURL=LegacyListItemView.js.map
