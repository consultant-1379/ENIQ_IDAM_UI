...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/util/UIUtils"], function ($, _, AbstractView, UIUtils) {
    return AbstractView.extend({
        ...
        render: function render(args, element, itemID, firstChild, callback) {
            var self = this;
        ...
        rebindElement: function rebindElement() {
            this.delegateEvents();
        },
        ...
        checkOptions: function checkOptions(e) {
...
//# sourceMappingURL=OperatorRulesView.js.map
