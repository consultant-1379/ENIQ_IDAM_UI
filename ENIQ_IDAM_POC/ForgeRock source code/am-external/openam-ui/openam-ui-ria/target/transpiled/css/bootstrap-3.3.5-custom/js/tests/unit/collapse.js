...
$(function () {
  ...
  QUnit.test('should add "collapsed" class to target when collapse is hidden', function (assert) {
    ...
    $('<div id="test1" class="in"/>').appendTo('#qunit-fixture').on('hidden.bs.collapse', function () {
  ...
  QUnit.test('should not close a collapse when initialized with "show" option if already shown', function (assert) {
    ...
    var $test = $('<div id="test1" class="in"/>').appendTo('#qunit-fixture').on('hide.bs.collapse', function () {
      assert.ok(false);
    });
  ...
  QUnit.test('should hide a collapse when initialized with "hide" option if not already hidden', function (assert) {
    ...
    $('<div class="collapse in"></div>').appendTo('#qunit-fixture').on('hide.bs.collapse', function () {
  ...
  QUnit.test('should remove "collapsed" class from active accordion target', function (assert) {
    ...
    var accordionHTML = '<div class="panel-group" id="accordion">' + '<div class="panel"/>' + '<div class="panel"/>' + '<div class="panel"/>' + '</div>';
    ...
    $('<div id="body3"/>').appendTo($groups.eq(2)).on('shown.bs.collapse', function () {
  ...
  QUnit.test('should allow dots in data-parent', function (assert) {
    ...
    var accordionHTML = '<div class="panel-group accordion">' + '<div class="panel"/>' + '<div class="panel"/>' + '<div class="panel"/>' + '</div>';
    var $groups = $(accordionHTML).appendTo('#qunit-fixture').find('.panel');
  ...
  QUnit.test('should change aria-expanded from active accordion target to "false" and set the newly active one to "true"', function (assert) {
    ...
    $('<div id="body3" aria-expanded="false"/>').appendTo($groups.eq(2)).on('shown.bs.collapse', function () {
  ...
  QUnit.test('should not fire show event if show is prevented because other element is still transitioning', function (assert) {
    ...
    var accordionHTML = '<div id="accordion">' + '<div class="panel"/>' + '<div class="panel"/>' + '</div>';
    var showFired = false;
    var $groups = $(accordionHTML).appendTo('#qunit-fixture').find('.panel');

    var $target1 = $('<a role="button" data-toggle="collapse" href="#body1" data-parent="#accordion"/>').appendTo($groups.eq(0));

    $('<div id="body1" class="collapse"/>').appendTo($groups.eq(0)).on('show.bs.collapse', function () {
      showFired = true;
    });
    ...
    $body2.toggleClass('in collapsing').data('bs.collapse').transitioning = 1;
