...
define([], function () {
    var obj = {
        moduleDefinition: [{
            ...
            configuration: {
                routes: {},
                loader: [{ "routes": "config/routes/AMRoutesConfig" }, { "routes": "config/routes/CommonRoutesConfig" }, { "routes": "config/routes/UserRoutesConfig" }, { "routes": "config/routes/admin/RealmsRoutes" }, { "routes": "config/routes/admin/GlobalRoutes" }, { "routes": "config/routes/user/UMARoutes" }]
            }
        }, {
            ...
            configuration: {
                processConfigurationFiles: ["config/process/AMConfig", "config/process/CommonConfig"]
            }
        }, {
            ...
            configuration: {
                templateUrls: ["templates/common/components/table/ReadOnlyRow.html", "templates/common/components/table/NewRow.html", "templates/common/components/table/EditRow.html"],
                partialUrls: ["partials/form/_JSONSchemaFooter.html", "partials/form/_AutoCompleteOffFix.html", "partials/form/_Button.html", "partials/form/_Select.html", "partials/headers/_Title.html", "partials/headers/_TitleWithSubAndIcon.html", "partials/login/_Choice.html", "partials/login/_Confirmation.html", "partials/login/_Default.html", "partials/login/_HiddenValue.html", "partials/login/_Password.html", "partials/login/_Redirect.html", "partials/login/_RememberLogin.html", "partials/login/_ScriptTextOutput.html", "partials/login/_SelfService.html", "partials/login/_SocialAuthn.html", "partials/login/_TextInput.html", "partials/login/_TextOutput.html", "partials/login/_PollingWait.html"]
            }
        }, {
            moduleClass: "org/forgerock/commons/ui/common/components/Messages",
            configuration: {
                messages: {},
                loader: [{ "messages": "config/messages/CommonMessages" }, { "messages": "config/messages/UserMessages" }, { "messages": "config/AppMessages" }]
            }
        }, {
            moduleClass: "org/forgerock/commons/ui/common/main/ValidatorsManager",
            configuration: {
                validators: {},
                loader: [{ "validators": "config/validators/CommonValidators" }, { "validators": "config/validators/AMValidators" }]
            }
        }, {
