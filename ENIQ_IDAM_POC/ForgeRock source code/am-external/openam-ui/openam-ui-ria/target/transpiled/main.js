...
define("reactAutosizeInputDep", ["react"], function (React) {
    window.React = React;
    return {};
});

define("reactSelectDep", ["react-dom", "react-input-autosize", "classnames"], function (ReactDOM, autoSize, classNames) {
...
require(["org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager",

// other modules that are necessary to include to startup the app
"jquery", "lodash", "backbone", "handlebars", "i18next", "spin", "org/forgerock/commons/ui/common/main", "org/forgerock/openam/ui/main", "config/main", "store/index"], function (Constants, EventManager) {
