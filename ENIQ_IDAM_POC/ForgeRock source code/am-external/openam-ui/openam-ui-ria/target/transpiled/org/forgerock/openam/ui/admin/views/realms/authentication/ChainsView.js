...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/openam/ui/admin/services/realm/AuthenticationService", "org/forgerock/openam/ui/admin/utils/FormHelper", "org/forgerock/openam/ui/common/util/array/arrayify", "org/forgerock/openam/ui/common/util/Promise"], function ($, _, Messages, AbstractView, AuthenticationService, FormHelper, arrayify, Promise) {
    ...
    var ChainsView = AbstractView.extend({
        ...
        chainSelected: function chainSelected(event) {
        ...
        deleteChain: function deleteChain(event) {
            var self = this,
        ...
        deleteChains: function deleteChains(event, selectedChains) {
            var self = this,
                element = event.currentTarget,
