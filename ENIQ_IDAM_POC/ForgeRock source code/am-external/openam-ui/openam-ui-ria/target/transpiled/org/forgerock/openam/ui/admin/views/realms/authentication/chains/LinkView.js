...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/components/BootstrapDialog", "handlebars", "org/forgerock/commons/ui/common/util/UIUtils"], function ($, _, AbstractView, BootstrapDialog, Handlebars, UIUtils) {
    var LinkView = AbstractView.extend({
        ...
        renderArrows: function renderArrows() {
            var html = Handlebars.compile("{{> templates/admin/views/realms/authentication/chains/_CriteriaFooter type='" + this.data.linkConfig.criteria + "'}}");
        ...
        getModuleDesciption: function getModuleDesciption() {
