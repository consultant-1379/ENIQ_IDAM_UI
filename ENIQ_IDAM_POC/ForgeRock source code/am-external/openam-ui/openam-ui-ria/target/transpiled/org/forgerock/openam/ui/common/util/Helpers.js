...
define(["jquery", "handlebars", "lodash", "org/forgerock/openam/ui/common/util/ExternalLinks"], function ($, Handlebars, _, ExternalLinks) {
    ...
    Handlebars.registerHelper("ternary", function (testExpression, yes, no) {
