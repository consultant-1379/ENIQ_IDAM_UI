...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants"], function ($, _, Messages, EventManager, Constants) {
    /**
    ...
    obj.errorHandler = function (response) {
        if (_.get(response, "status") === 401) {
            ...
            Messages.addMessage({ type: Messages.TYPE_DANGER, escape: true, response: response });
        } else {
