...
define(["jquery", "lodash", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/openam/ui/common/util/array/arrayify", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openam/ui/admin/views/realms/authentication/EditModuleDialog", "org/forgerock/openam/ui/admin/models/Form", "org/forgerock/openam/ui/admin/utils/FormHelper", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/openam/ui/common/util/Promise", "org/forgerock/openam/ui/admin/services/realm/AuthenticationService",

// jquery dependencies
"selectize"], function ($, _, AbstractView, arrayify, Configuration, EditModuleDialog, Form, FormHelper, Messages, Promise, AuthenticationService) {
    ...
    function performDeleteModules(realmPath, moduleInfos) {
        return Promise.all(arrayify(moduleInfos).map(function (moduleInfo) {
            return AuthenticationService.authentication.modules.remove(realmPath, moduleInfo.moduleName, moduleInfo.moduleType);
        }));
    }
    ...
    var ModulesView = AbstractView.extend({
        ...
        data: {},
        moduleSelected: function moduleSelected(event) {
        ...
        editModule: function editModule(event) {
        ...
        deleteModule: function deleteModule(event) {
            var self = this,
        ...
        deleteModules: function deleteModules(event, selectedModules) {
            var self = this,
                element = event.currentTarget,
