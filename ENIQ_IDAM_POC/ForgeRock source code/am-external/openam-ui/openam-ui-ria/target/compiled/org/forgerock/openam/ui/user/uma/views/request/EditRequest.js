...
define(["jquery", "backbone", "org/forgerock/commons/ui/common/backgrid/Backgrid", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/openam/ui/common/services/fetchUrl", "org/forgerock/openam/ui/common/util/BackgridUtils", "org/forgerock/openam/ui/user/uma/services/UMAService", "org/forgerock/openam/ui/user/uma/views/backgrid/cells/PermissionsCell"], function ($, Backbone, Backgrid, AbstractView, Configuration, Router, Constants, fetchUrl, BackgridUtils, UMAService, PermissionsCell) {
    var EditRequest = AbstractView.extend({
        ...
        allowRequest: function allowRequest() {
        ...
        render: function render(args, callback) {
            ...
            RequestCollection = Backbone.Collection.extend({
                url: Constants.context + "/json" + fetchUrl.default("/users/" + Configuration.loggedUser.get("username") + "/uma/pendingrequests/" + id)
            });
