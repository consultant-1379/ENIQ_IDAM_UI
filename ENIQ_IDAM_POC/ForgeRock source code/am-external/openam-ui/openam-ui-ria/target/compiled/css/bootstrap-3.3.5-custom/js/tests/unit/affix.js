...
$(function () {
  ...
  QUnit.test('should trigger affixed event after affix', function (assert) {
    ...
    var templateHTML = '<div id="affixTarget">' + '<ul>' + '<li>Please affix</li>' + '<li>And unaffix</li>' + '</ul>' + '</div>' + '<div id="affixAfter" style="height: 20000px; display: block;"/>';
    ...
    $('#affixTarget').on('affix.bs.affix', function () {
  ...
  QUnit.test('should affix-top when scrolling up to offset when parent has padding', function (assert) {
    ...
    var templateHTML = '<div id="padding-offset" style="padding-top: 20px;">' + '<div id="affixTopTarget">' + '<p>Testing affix-top class is added</p>' + '</div>' + '<div style="height: 1000px; display: block;"/>' + '</div>';
    $(templateHTML).appendTo(document.body);
