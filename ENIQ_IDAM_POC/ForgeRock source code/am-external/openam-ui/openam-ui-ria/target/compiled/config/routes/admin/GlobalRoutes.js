...
define(["lodash"], function (_) {
    ...
    _.each(["general", "security", "session", "sdk", "cts", "uma", "advanced", "directoryConfiguration"], function (suffix) {
    ...
    _.each(["general", "security", "session", "sdk", "cts", "uma", "advanced"], function (suffix) {
