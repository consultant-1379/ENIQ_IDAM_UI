...
export default class UmAppsGroups extends LitComponent {
  ...
  didConnect(){
    ...
    this.apps_data=[{"label":"AdminUI"},{"label": "AlarmCfg"}, {"label":"BI"}, {"label":"Launcher page"}, 
  ...
  didRender(){
    setTimeout(()=>{ 
      this.apps= this.shadowRoot.querySelector("#apps")
      .shadowRoot.querySelectorAll("div > ul > eui-tree-item");
       this.groups= this.shadowRoot.querySelector("#groups")
        .shadowRoot.querySelectorAll("div > ul > eui-tree-item");
...
unselect_groupchild(group_item){
  let child_items = group_item.querySelectorAll("eui-tree-item");
  ...
  render() {
    ...
    <div id="app-groups">
          ...
          <!--Groups-->
                <div class="form-fields ${this.class}">
                    <label>Groups</label>
                    <eui-tree id="groups" multi-select
