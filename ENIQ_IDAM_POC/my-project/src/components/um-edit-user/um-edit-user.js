 ...
 */
 ...
 didConnect(){
   ...
   this.data=[
     ...
     { col1: 'ClOGNEc', col2: 'John', col3: 'Smith', col4: 'j.bloggs@yahoo.com', col5: 'NetAn', col6: 'NetAn Admin', col7: 'Enabled' },
   ];
 ...
 didRender(){
   ...
   setTimeout(()=>{
      //collect form text fields
       ...
       //collecting apps  
       this.apps=this.shadowRoot.querySelector("#edit-user e-um-apps-groups")
       .shadowRoot.querySelector("#apps").shadowRoot.querySelectorAll("eui-tree-item");
       //collecting groups
       this.groups=this.shadowRoot.querySelector("#edit-user e-um-apps-groups")
 ...
 update_formfields(userdata){
   ...
   for(let data_item in userdata ){
     for(let textfield of this.form_textfields){ 
   ...
   for(let userapp of userdata.apps){
   ...
   for(let userapp of userdata.apps){
     this.groups.forEach(group=>{
       if(group.innerText == userapp){        
         ...
         let group_subapps = group.querySelectorAll("eui-tree-item");
         let total_subapps=group_subapps.length;
         for(let subapp of group_subapps){
           userdata.groups.forEach(usergroup=>{            
             if(usergroup.toLowerCase().trim() == subapp.innerText.toLowerCase().trim()){
                subapps_checkCount++;
               ...
               <div class="fields column-1">
                 <div class="title">Personal information</div>
                   ...
                   <div class="form-fields">
                     ...
                     <eui-text-field name="email" placeholder="Email" id="email" id="email"
            ...
            <div class="content-block">
               ...
               <div class="fields column-1">
                   ...
                   <div class="form-fields">
                       ...
                       <eui-text-field name="username" placeholder="Username" id="username" readonly
                       pattern="^[A-Za-z]+$"></eui-text-field>
                   </div>
