...
export default class UmAddUser extends LitComponent {
...
didRender(){
  ...
  this.confirm_password_input=this.shadowRoot.querySelector("#confirm-password");
...
validate_confirm_password(confirmPassword){
  ...
  let confirm_password =confirmPassword.toLowerCase()
...
formfields_collection(){
  let form_fields={};
  let form_textfields = this.shadowRoot.querySelectorAll("#add-user  eui-text-field");
  let apps=this.shadowRoot.querySelector("#add-user  e-um-apps-groups")
  .shadowRoot.querySelector("#apps").shadowRoot.querySelectorAll(" eui-tree-item");
  let groups=this.shadowRoot.querySelector("#add-user  e-um-apps-groups")
  .shadowRoot.querySelector("#groups").shadowRoot.querySelectorAll("ul>eui-tree-item");
...
collect_formdata(){
  let formdata={};
  //collecting form fields
  let form_fields = this.formfields_collection();
  //adding form text fields to formdata object
   for(let field of form_fields.textfields ){
  ...
  formdata.apps=[];
  for(let app of form_fields.apps){
  ...
  formdata.groups=[];
  for(let group of form_fields.groups){
    if(group.hasAttribute("checked") || group.hasAttribute("indeterminate")){
      let child_items = group.querySelectorAll("eui-tree-item[checked]");
...
clear_form(){
  ...
  for(let field of form_fields.textfields ){field.value = ''; } 
  ...
  for(let app of form_fields.apps){
    if(app.hasAttribute("checked")){app.removeAttribute("checked");}       
  }
  ...
  for(let group of form_fields.groups){
    ...
    if(group.hasAttribute("checked")){group.removeAttribute("checked");}            
    if(group.hasAttribute("indeterminate")){group.removeAttribute("indeterminate");}
...
save_user(){
  ...
  if(this.required_fields()){
    ...
    let formdata=this.collect_formdata();
            ...
            <div class="fields column-1">
               <div class="title">Personal information</div>
                ...
                <div class="form-fields">
                  ...
                  <eui-text-field name="first_name" placeholder="First name"
                ...
                <div class="form-fields">
                  ...
                  <eui-text-field name="last_name" placeholder="Last name"
                  pattern="^[A-Za-z]+$"></eui-text-field>
                </div>
         ...
         <div class="content-block">
            ...
            <div class="fields column-1">
                ...
                <div class="form-fields">
                    ...
                    <eui-text-field name="username" placeholder="Username" id="username"
                    pattern="^[A-Za-z]+$"></eui-text-field>
                </div>
                ...
                <div class="form-fields">
                    ...
                    <eui-password-field name="password" placeholder="Password" id="password"
                    @input="${this}" >
                    </eui-password-field>
                </div>
                ...
                <!--apps and groups-->
                <e-um-apps-groups class="user-form">
                </e-um-apps-groups>
            ...
            <div class="policies column-2">
              ...
              <div class="access-control">
                 ...
                 <div class="content">
                     <p>A user cannot be assigned to a group if an application/s has not been selected.
                      To enable group/s selection, an application/s must be selected.</p>
                 </div>
              </div>
            </div>
        </div>
        ...
        <div class="content-block">
            ...
            <div class="title">User status</div>
              ...
              <div class="form-fields">
                  ...
                  <eui-switch id="status" label-off="Disable" label-on="Enable" on></eui-switch>
              </div>
            </div>
